...
our [Contributor's Guide](https://docs.github.com/en/communities/setting-up-your-project-for-healthy-contributions/setting-guidelines-for-repository-contributors).
...
that your question is tagged with the `javascript & aws-sdk` tag when asking it on
