...
[`@aws-sdk/xhr-http-handler`](https://www.npmjs.com/package/@aws-sdk/xhr-http-handler/v/3.353.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/xhr-http-handler@3.353.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JDhWMSkbfHFSq2/2G+NLLhbKFbCWM/tpMrkb/GsGnbWS1TO6Q5X1ioLpE8I9m+ap
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/xhr-http-handler": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/xhr-http-handler@3.353.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/xhr-http-handler@3.353.0/index.min.mjs": "sha384-JDhWMSkbfHFSq2/2G+NLLhbKFbCWM/tpMrkb/GsGnbWS1TO6Q5X1ioLpE8I9m+ap"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/xhr-http-handler/blob/refs/tags/3.353.0/LICENSE
```
