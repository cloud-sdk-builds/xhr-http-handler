...
[`@aws-sdk/xhr-http-handler`](https://www.npmjs.com/package/@aws-sdk/xhr-http-handler/v/3.249.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/xhr-http-handler@3.249.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ko5vShSJb9QT5kb5or15oXph8yxsQJiluJV6t0jFZqENmU8XPa+e7nNZ2dMIcACf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/xhr-http-handler": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/xhr-http-handler@3.249.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/xhr-http-handler@3.249.0/index.min.mjs": "sha384-ko5vShSJb9QT5kb5or15oXph8yxsQJiluJV6t0jFZqENmU8XPa+e7nNZ2dMIcACf"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.249.0`)
...
```
https://github.com/cloud-sdk-builds/xhr-http-handler/blob/refs/tags/3.249.0/LICENSE
```
