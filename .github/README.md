...
[`@aws-sdk/xhr-http-handler`](https://www.npmjs.com/package/@aws-sdk/xhr-http-handler/v/3.1028.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/xhr-http-handler@3.1028.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/xhr-http-handler": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/xhr-http-handler@3.1028.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/xhr-http-handler@3.1028.0/index.min.mjs": "sha384-h92JzO5Uu8aEEtmLlHlv7n+/8olqZgqYBnwoLEXfcE3OYB/huAxcCRCNwRY/lrlX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/xhr-http-handler/blob/refs/tags/3.1028.0/LICENSE
```
