...
[`@aws-sdk/xhr-http-handler`](https://www.npmjs.com/package/@aws-sdk/xhr-http-handler/v/3.370.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/xhr-http-handler@3.370.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MfemXGWVSWJsD/Ke2oeVy93pEtiwUHBVGAytmbQJas8z7YEXViT5B+Pxz8lfT59i
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/xhr-http-handler": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/xhr-http-handler@3.370.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/xhr-http-handler@3.370.0/index.min.mjs": "sha384-MfemXGWVSWJsD/Ke2oeVy93pEtiwUHBVGAytmbQJas8z7YEXViT5B+Pxz8lfT59i"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/xhr-http-handler/blob/refs/tags/3.370.0/LICENSE
```
